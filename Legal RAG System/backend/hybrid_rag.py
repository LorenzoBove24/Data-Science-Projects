...
def _classify_law(
    ...
    system_prompt = (
        "You are a classifier for European civil law queries (specifically Italy, Estonia, and Slovenia).\n"
...
def _extract_legal_metadata_from_query(
    ...
    system_prompt = (
       "You are a legal metadata extraction assistant for European civil law cases (Italy, Estonia, Slovenia).\n"
...
def hybrid_answer_question(
    ...
    system_prompt = (
        "You are a legal assistant for European civil law (Italy, Estonia, Slovenia), focusing on inheritance (succession) and divorce cases.\n"
        "You receive:\n"
    ...
    user_parts.append(
        "Provide a clear, concise answer, explicitly stating if any parts of your response are general assessments rather than being based on specific retrieved documents."
    )
